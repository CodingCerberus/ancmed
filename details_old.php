		...
		<section class="mainBody" id="blurMainBody">
			<section>
				...
				<section class="wrapper">
					<span class="listCategories">Cat. No.</span> <span>				
                        <?php echo $row2['number']; ?></span>
					<span class="listCategories">Date</span> <span>
                        <?php echo $row2['date_entry']; ?></span>
					<span class="listCategories">Findspot</span> <span>
                        <?php echo $row2['findspot']; ?></span>
                    <span class="listCategories">Dimensions</span> <span>
                        <?php echo $row2['dimensions']; ?></span>
                    <span class="listCategories">Medium</span> <span>
                        <?php echo $row2['medium']; ?></span>
					<span class="listCategories">Accession Number</span> <span>
                        <?php echo $row2['accession_number']; ?></span>
                    <span class="listCategories">References</span> <span>
                        <?php echo $row2['refs']; ?></span>
				</section>
				...
				<section class="collapsingArea">
					...
					<section class="collapseBuffer">	
						...
						<?php 
						  ...
						  {
							$query = 'SELECT * FROM biblio WHERE id IN (' . $row2['bibliography'] . ')';
							//echo $query . ' ' . $rows;
								$result = $conn->query($query);
							if (!$result) die($conn->error);
			...
			<section>
			  <img src=<?php echo GetImage( $row2['excel_row']); ?> >
            <p>Image View</p>
			</section>
		</section>
